...
from components.components_parameters import distribution_widgets as widget_plot_type_parameters
...
def distribution_parameters(in_list_kwargs = in_list_kwargs, 
