...
from components.components_parameters import categorical_widgets as widget_plot_type_parameters
...
from seaborn import catplot, color_palette
...
def categorical_parameters(in_list_kwargs = in_list_kwargs, 
